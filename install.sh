#!/usr/bin/env bash
# ═══════════════════════════════════════════════════════════════════════════
# tmux-auto-claude-config install script
...
# (installed by tmux-auto-claude-config — survives repo deletion)
...
if command -v claude >/dev/null 2>&1; then
  ...
  warn "  The _autoclaude aliases (autoclaude, easybutton, etc.) won't work until"
